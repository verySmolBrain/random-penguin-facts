...
["_fflush","__embind_initialize_bindings","onRuntimeInitialized"].forEach((prop) => {
...
function qt_jspi_resume_js() { if (!Module.qtJspiSuspensionCounter) return false; --Module.qtJspiSuspensionCounter; setTimeout(() => { const wakeUp = (Module.qtAsyncifyWakeUp ?? []).pop(); if (wakeUp) wakeUp(); }); return true; }
function qt_jspi_can_resume_js() { return Module.qtJspiSuspensionCounter > 0; }
function init_jspi_support_js() { Module.qtAsyncifyWakeUp = []; Module.qtJspiSuspensionCounter = 0; }
...
var ___start_em_js = Module['___start_em_js'] = 8404772;
var ___stop_em_js = Module['___stop_em_js'] = 8405862;

...
EMSCRIPTEN_BINDINGS(main_module) {
    ...
    emscripten::class_<Visitor>("Visitor")
        .function("visit", emscripten::select_overload<std::string(CatHabitat*)>(&Visitor::visit), emscripten::allow_raw_pointers())
        .function("visit", emscripten::select_overload<std::string(PenguinHabitat*)>(&Visitor::visit), emscripten::allow_raw_pointers());
